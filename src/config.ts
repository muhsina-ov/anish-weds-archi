export const wedding = {
  ...
  program: [
    { name: "Ramayan Path · Ghai Niwas", time: "Nov 6 · Thu" },
    { name: "Shagun · Ghai Niwas", time: "Nov 9 · Morning" },
    { name: "Mehendi · Ghai Niwas", time: "Nov 9 · Night" },
    { name: "Saant · Ghai Niwas", time: "Nov 10 · Morning" },
    { name: "Baraat · RK Resort", time: "Nov 10 · Night" },
    { name: "Reception · Vivah Vatika", time: "Nov 11 · Evening" },
  ],
