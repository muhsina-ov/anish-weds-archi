      ...
      {!isOpen && (
        ...
        >
          ...
          <motion.div
            ...
            className="relative z-10 mx-auto max-w-lg w-full rounded-3xl border-2 border-amber-400 bg-white/95 p-7 sm:p-10 text-center shadow-[0_25px_60px_-15px_rgba(217,119,6,0.35)] ring-8 ring-amber-400/15 backdrop-blur-md"
          >
            ...
            {/* Subtitle */}
            <p className="font-cinzel text-xs font-bold uppercase tracking-[0.28em] text-amber-800">
              Wedding Invitation
            </p>
            ...
            <p className="font-cinzel text-xs tracking-widest text-amber-900/80 mt-1 font-semibold">
              {wedding.groomFull} &amp; {wedding.brideFull}
            </p>

            {/* Special Highlight: November 11 Reception Highlighted prominently */}
            <div className="my-5 rounded-2xl border-2 border-amber-400/90 bg-gradient-to-r from-amber-50 via-rose-50/60 to-amber-50 p-4 text-xs text-amber-950 shadow-inner">
            ...
            <p className="mt-3 text-[11px] uppercase tracking-widest text-amber-900/60">
              Tap to enter with joyful shehnai &amp; festive flower shower
            </p>
          </motion.div>
        </motion.div>
      )}
